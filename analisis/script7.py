...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 4:
        print("Usage: python script.py <start_date> <end_date> <percentage>")
        sys.exit(1)
    
    base_path = '../results/'  # Predefined base path
    start_date = sys.argv[1]
    end_date = sys.argv[2]
    percentage = sys.argv[3]  # Capture the action name from command line
    ...
    command = ['python', '7.py', '--percent=' + percentage] + files
